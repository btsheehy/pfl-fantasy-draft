...
const Player: React.FC = observer(() => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (playerId) {
        const metadata = await playerMetadataStore.fetchPlayerMetadata(parseInt(playerId));
        ...
        <div className="p-4">
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
            ...
            <div className="bg-gray-100 p-2 rounded">
              ...
              <p className="text-sm font-semibold">{player.experience || 'Rookie'}</p>
            </div>
            <div className="bg-gray-100 p-2 rounded">
            ...
            <div className="bg-gray-100 p-2 rounded">
              ...
              <p className="text-sm font-semibold">{player.projectedFantasyPoints}</p>
            </div>
            <div className="bg-gray-100 p-2 rounded">
            ...
            <div className="bg-gray-100 p-2 rounded">
              ...
              <p className="text-sm font-semibold">{player.lastYrFppg || 'N/A'}</p>
            </div>
            <div className="bg-gray-100 p-2 rounded">
            ...
            <div className="bg-gray-100 p-2 rounded">
              ...
              <p className="text-sm font-semibold">{player.teamName || 'Free Agent'}</p>
            </div>
            {player.teamName && 
            <>
            <div className="bg-gray-100 p-2 rounded">
          ...
          <div className="mt-4 bg-gray-100 p-3 rounded">
            <label className="block text-sm font-medium text-gray-700">Your Value</label>
            <input
              type="number"
              value={userValue}
